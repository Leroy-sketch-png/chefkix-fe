...
export default function PantryPage() {
	...
	const activeCategoryLabel = filterCategory
		? t(
				CATEGORIES.find(category => category.key === filterCategory)
					?.labelKey ?? 'all',
			)
		: t('all')
				...
				<div className='grid grid-cols-1 gap-6 py-6'>
					<div className='space-y-6'>
						<PantryCommandDeck
							...
							showingCategory={activeCategoryLabel}
							hasSuggestionsOpen={showSuggestions}
							onOpenSuggestions={loadSuggestions}
							onClearExpired={() => setShowClearExpiredConfirm(true)}
													...
													{editingId === item.id ? (
														...
														<div className='flex flex-1 flex-wrap items-center gap-2'>
															...
															<input
																...
																className='w-16 rounded-md border border-border-subtle bg-bg px-2 py-1 text-sm text-text-primary [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none focus:border-brand focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/50'
															...
															<input
																...
																className='w-16 rounded-md border border-border-subtle bg-bg px-2 py-1 text-sm text-text-primary focus:border-brand focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/50'
															...
															<input
																...
																className='w-36 rounded-md border border-border-subtle bg-bg-card px-2 py-1 text-sm text-text-primary focus:border-brand focus:outline-none focus-visible:ring-2 focus-visible:ring-brand/50'
															/>
															<motion.button
																type='button'
																onClick={saveEdit}
														...
														<>
															...
															<div className='flex items-center gap-0.5 opacity-50 transition-opacity group-hover:opacity-100 focus-within:opacity-100'>
																<motion.button
																	...
																	whileTap={BUTTON_SUBTLE_TAP}
																	className='flex size-10 items-center justify-center rounded-md text-text-muted hover:bg-bg-elevated hover:text-text-primary focus-visible:ring-2 focus-visible:ring-brand/50'
