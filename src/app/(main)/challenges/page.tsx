												...
												>
													<div className='mb-3 flex items-center justify-between z-10 relative'>
														<div className='flex items-center gap-3'>
															...
															<div>
																<h3 className='text-lg font-bold text-text-primary group-hover:text-brand transition-colors duration-300'>
													...
													{/* Time remaining */}
													<p className='text-xs text-text-muted z-10 relative'>
														{formatEventTimeRemaining(
															weeklyChallenge.endsAt,
															t,
														)}
													</p>
													...
													{!weeklyChallenge.completed &&
														...
														weeklyChallenge.matchingRecipes.length > 0 && (
															<button
																...
																className='mt-3 flex items-center gap-1.5 text-sm font-semibold text-brand transition-colors hover:text-brand/80 disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-brand/50 z-10 relative'
															>
												...
												{communityChallenges.map((ch, i) => (
													...
													>
														...
														>
															...
															<div className='flex items-center justify-between text-xs text-text-muted z-10 relative'>
												...
												{seasonalChallenges.map((ev, i) => (
													...
													>
														...
														>
															...
															{ev.heroImageUrl ? (
																<div
																	className='relative h-28 bg-cover bg-center z-10'
																	style={{
																...
																<div
																	className='flex h-20 items-center gap-3 px-5 z-10 relative'
																	style={{
