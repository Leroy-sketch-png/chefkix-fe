		...
		<AnimatePresence>
			{visible && current && (
				<motion.div
					...
					exit={{ opacity: 0, y: -10 }}
					className='pointer-events-none absolute bottom-16 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-full bg-bg-elevated/95 px-4 py-2 shadow-warm backdrop-blur-sm'
				>
