				...
				>
					...
					>
						...
						<button
							...
							className='absolute right-2 top-2 flex size-10 items-center justify-center rounded-full text-text-muted transition-colors hover:bg-bg-elevated hover:text-text-primary focus-visible:ring-2 focus-visible:ring-brand/50 sm:right-3 sm:top-3 z-50'
						...
						{/* Content */}
						<div className='flex items-start gap-3 sm:gap-4 relative p-4 md:p-5'>
							{/* Emoji / Icon */}
							...
							<div className='min-w-0 flex-1 z-40'>
								{/* Header */}
									...
									<div className='mt-3'>
										<div className='mb-1 flex items-center justify-between text-xs'>
											<span className='tabular-nums text-text-secondary'>
												<NumberTicker value={challenge.userProgress} /> /{' '}
												{challenge.targetCount} {challenge.targetUnit}
											</span>
											<span className='font-semibold tabular-nums text-brand'>
												<NumberTicker value={progressPercent} suffix='%' />
											</span>
										</div>
								...
								<div className='mt-2.5 flex flex-wrap items-center gap-2.5 sm:mt-3 sm:gap-3'>
									{challenge.rewardXp > 0 && (
										<span className='flex items-center gap-1 text-xs font-semibold text-xp'>
											...
											<NumberTicker value={challenge.rewardXp} /> XP
