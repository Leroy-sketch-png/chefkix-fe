				...
				<div className='flex items-center gap-2 border-t p-3'>
					{selectedConversation ? (
						...
						<Link
							href={PATHS.MESSAGES}
							onClick={toggleMessagesDrawer}
							className='flex w-full items-center justify-center gap-2 rounded-xl bg-bg-elevated py-2 text-sm font-medium transition-colors hover:bg-bg-hover'
						>
