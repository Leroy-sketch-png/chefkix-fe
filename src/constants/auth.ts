...
const KNOWN_ROUTE_SEGMENTS = new Set([
	'admin', 'challenges', 'collections', 'community', 'cook-card',
	'cook-together', 'create', 'creator', 'dashboard', 'discover',
	'explore', 'feed', 'friends', 'groups', 'leaderboard', 'meal-planner',
	'messages', 'notifications', 'pantry', 'post', 'profile', 'recipes',
	'search', 'settings', 'shopping-lists', 'auth', '_dev',
])
