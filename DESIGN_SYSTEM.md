...
| ---------------- | -------------------- | --------------------------- |
| Feed/Timeline    | `max-w-lg` (800px)   | Single-column reading       |
| Grid/Discovery   | `max-w-xl` (1000px)  | Multi-column cards          |
| Recipe Detail    | `max-w-2xl` (1400px) | Rich content, images        |
| Focused Creation | `max-w-md` (600px)   | Single task, no distraction |
| Forms/Settings   | `max-w-lg` (800px)   | Scannable, not stretched    |
...
| `max-w-sm`   | 480px  | Narrow modals    |
| `max-w-md`   | 600px  | Focused creation |
| `max-w-lg`   | 800px  | Feed, forms      |
| `max-w-xl`   | 1000px | Grids            |
| `max-w-form` | 900px  | Wide forms       |
